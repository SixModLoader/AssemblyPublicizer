...
namespace AssemblyPublicizer.Library
{
    public class Publicizer
    {
        public static string Suffix { get; set; } = "_publicized";
        public static string DefaultOutputDir { get; set; } = "publicized_assemblies";
